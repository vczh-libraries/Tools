...
- Computer Use:
  ...
  - For any GacUI app, the first choise is always automation service, then UI Automation, then general computer use, checkout `Tools/Coplilot/Guidelines/Running-GacUI.md` for details.
  - For any CLI app, the first choise is always starting it in an interactive CLI session, checkout `Tools/Coplilot/Guidelines/Running-CLI.md` for details.
  - For any TUI app, when interacting with OS terminal host is not doable due to computer use failure, you can still start it in an interactive CLI session, checkout `Tools/Coplilot/Guidelines/Running-CLI.md` for details.
  - For OS native dialog, for Windows try UIA first, checkout `Tools/Coplilot/Guidelines/Running-ComputerUse.md` for details.
