...
- **Running Jobs List**: The portal home page displays a list of running/recent jobs with name, status, and time. A "Refresh" button updates the list, and each item has a "View" button to inspect the job in the tracking page
