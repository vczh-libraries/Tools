...
`REPO-ROOT/Copilot/Agent/packages/CopilotPortal/src/jobsData.ts` contains definition of all tasks and jobs.
Read `REPO-ROOT/Copilot/Agent/prompts/spec/CopilotPortal/JobsData.md` to understand the specification of jobsData.
