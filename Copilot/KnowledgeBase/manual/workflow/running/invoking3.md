...
Involved files:
- [Main.cpp](https://github.com/vczh-libraries/Release/blob/master/Tutorial/Console_Workflow/W04_InheritingCppClasses/Main.cpp)

Workflow classes are allowed to inherit from reflectable C++ classes. Here we have a C++ class, with two properties:
```
namespace myapi
{
