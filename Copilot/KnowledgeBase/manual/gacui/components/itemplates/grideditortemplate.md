...
- **\<GridEditorTemplate/\>**
  - **C++/Workflow**: (vl::)presentation::templates::GuiGridEditorTemplate*
...
- Source code:[control_datagrid_editor](https://github.com/vczh-libraries/Release/blob/master/SampleForDoc/GacUI/XmlRes/control_datagrid_editor/Resource.xml)
- ![](https://gaclib.net/doc/gacui/control_datagrid_editor.gif)
