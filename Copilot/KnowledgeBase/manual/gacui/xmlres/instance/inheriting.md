...
Typically, you don't want your**\<Instance/\>**to be in the default namespaces, so it is very common to use[xmlns:NAMESPACE](../../.././gacui/xmlres/instance/namespaces.md)for the base type like:
```
<Resource>
