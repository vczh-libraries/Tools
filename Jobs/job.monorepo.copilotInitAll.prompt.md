...
- Run `Tools/Tools/CheckRepo.ps1 Sync` to pull the latest changes from remotes, pay attention to pull failure, which means you need to resolve conflicts manually.
